package com.vbstudio.weather.fragment.adapter;
 ...
 */
public abstract class BaseRecyclerAdapter<M> extends RecyclerView.Adapter implements /*Response.Listener<JSONObject>, Response.ErrorListener,*/ View.OnClickListener {

    protected Context context;
    protected BaseFragment baseFragment;
    protected Boolean isClickAllowed = true;
    ...
    protected void flipOnClickListener(final View view, final RecyclerView.Adapter recyclerAdapter) {
